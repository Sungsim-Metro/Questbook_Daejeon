...
docker exec questbook-postgres psql -U questbook -d questbook -v ON_ERROR_STOP=1 -c "DROP SCHEMA IF EXISTS public CASCADE; CREATE SCHEMA public;"
docker exec -i questbook-postgres psql -U questbook -d questbook -v ON_ERROR_STOP=1 < database/migrations/001_baseline_schema.sql
```
